...
class LLMResponseParser:
    ...
    def parse_pick_and_place(
        ...
        # In action_and_path mode a compact PICK+PLACE action may append PATH
        # after the PLACE target.  Split it off before normalizing the target
        # name so commands like "PICK apple PLACE bin_front_left PATH [...]"
        # remain parseable.
        place_target_name = action_desp.split('PLACE')[1].split('PATH')[0].strip().replace(' ', '_')
